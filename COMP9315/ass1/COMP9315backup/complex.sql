...
-- Assume the user defined functions are in /srvr/z5089358/postgresql-10.4/src/tutorial/complex$DLSUFFIX
...
CREATE FUNCTION complex_in(cstring)
   RETURNS complex
   AS '/srvr/z5089358/postgresql-10.4/src/tutorial/complex'
...
CREATE FUNCTION complex_abs_lt(complex, complex) RETURNS bool
   AS '/srvr/z5089358/postgresql-10.4/src/tutorial/complex' LANGUAGE C IMMUTABLE STRICT;
